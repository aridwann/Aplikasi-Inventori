...
import dao.DAO_DetailBM;
import dao.DAO_KeranjangBM;
...
import tablemodel.TBM_DetailBM;
import tablemodel.TBM_KeranjangBM;
import tablemodel.TBM_BarangMasuk;
 ...
 * @author aridw
 */
public class TransaksiBarangMasuk extends javax.swing.JPanel {
    private Service_BarangMasuk serviceBM = new DAO_BarangMasuk();
    private Service_DetailBM serviceDBM = new DAO_DetailBM();
    private Service_KeranjangMasuk serviceKM = new DAO_KeranjangBM();
    private Service_Laporan serviceLap = new DAO_Laporan();

    
    private TBM_BarangMasuk tbmBM = new TBM_BarangMasuk();  
    private TBM_DetailBM tbmDBM = new TBM_DetailBM();  
    private TBM_KeranjangBM tbmKM = new TBM_KeranjangBM();  
    
    private int row;
    private String idP;
   
    public TransaksiBarangMasuk(String id) {
        initComponents();
        this.idP = id;
        ...
        tabelData.setModel(tbmBM);
        tabelDetail.setModel(tbmDBM);
        tabelKeranjang.setModel(tbmKM);
    ...
    private void initComponents() {
        ...
        lblJudul.setText("Data Barang Masuk");
        ...
        lblJudul2.setText("Detail Barang Masuk");
        ...
        lblTotalMasuk.setFont(new java.awt.Font("Inter", 1, 14)); // NOI18N
        lblTotalMasuk.setForeground(new java.awt.Color(255, 255, 255));
        lblTotalMasuk.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lblTotalMasuk.setText("Total Pemesanan : ");
        ...
        tfIdBarangMasuk.setEditable(false);
        tfIdBarangMasuk.setBackground(new java.awt.Color(17, 79, 109));
        tfIdBarangMasuk.setFont(new java.awt.Font("Inter", 0, 14)); // NOI18N
        tfIdBarangMasuk.setForeground(new java.awt.Color(153, 153, 153));
        tfIdBarangMasuk.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Id Barang Masuk", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Inter", 1, 12), new java.awt.Color(153, 153, 153))); // NOI18N
        pnInput.add(tfIdBarangMasuk, new org.netbeans.lib.awtextra.AbsoluteConstraints(24, 55, 250, 50));
        ...
        tfTanggalBarangMasuk.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Tanggal Barang Masuk", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Inter", 1, 12), new java.awt.Color(153, 153, 153))); // NOI18N
        ...
        pnInput.add(tfIdDistributor, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 160, 210, 50));
        ...
        pnInput.add(tfNamaBarang, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 330, 250, 50));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addComponent(lblTotalMasuk, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
        );
        ...
        pnUtama.add(tambahBarangMasuk, "card2");
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        ...
        tfIdBarangMasuk.setText(serviceBM.nomor());
    ...
    private void tabelDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelDataMouseClicked
        ...
        List<Model_DetailBM> list = serviceDBM.getById(id);
        tbmDBM.setData(list);
    ...
    private void loadData(){
        ...
        List<Model_BarangMasuk> list = serviceBM.getData();
        tbmBM.setData(list);
    }
    
    private void loadCartData(){
        List<Model_KeranjangMasuk> list = serviceKM.getData();
        tbmKM.setData(list);
    }
    ...
    private void showPanelAddData(){
        ...
        pnUtama.add(tambahBarangMasuk);
        pnUtama.repaint();
        pnUtama.revalidate();
        
        pilDistributor.setEnabled(true);
        serviceDBM.temporaryDelete();
        resetForm();
        loadCartData();
    }
    ...
    private void resetForm(){
        ...
        lblTotalMasuk.setText("Total Barang Masuk : ");
    }
    ...
    private void addDataChart(){
        if(validasiInput()){
            String idMasuk = tfIdBarangMasuk.getText();
            ...
            Model_BarangMasuk mp = new Model_BarangMasuk();
            Model_Barang mb = new Model_Barang();
            Model_DetailBM mdBM = new Model_DetailBM();
            Model_KeranjangMasuk mkm = new Model_KeranjangMasuk();

            mp.setId_barang_masuk(idMasuk);

            mb.setId_barang(id);
            mb.setNama_barang(nama);
            mb.setHarga_beli(hargaBeli);

            mdBM.setJumlah_masuk(jumlah);
            mdBM.setSubtotal_masuk(subTotal);
            mdBM.setStatus("Masuk");

            mkm.setBarang_masuk(mp);
            mkm.setBarang(mb);
            mkm.setDetail_barang_masuk(mdBM);

            serviceKM.addData(mkm);
            lblTotalMasuk.setText("Total Barang Masuk : " + serviceDBM.sumTotal());
    ...
    private void deleteDataChart(){
        ...
        if(row != -1){
            if(JOptionPane.showConfirmDialog(null, "Yakin Ingin Menghapus?", "Konfirmasi", JOptionPane.OK_CANCEL_OPTION) == JOptionPane.OK_OPTION){
                serviceKM.deleteData(tabelKeranjang.getModel().getValueAt(row, 0).toString());
                tbmKM.deleteData(row);
                lblTotalMasuk.setText("Total Barang Masuk : " + serviceDBM.sumTotal());
                loadCartData();
                clearTfBarang();
            }else{
    ...
    private void updateDataCart() {
        if(validasiInput()){
            ...
            int totMasuk = Integer.parseInt(lblTotalMasuk.getText().substring(21));
            ...
            mbm.setId_barang_masuk(idMasuk);
            mbm.setTgl_masuk(tglMasuk);
            mbm.setTotalmasuk(totMasuk);
            mbm.setStatus(status);
            ...
            mbm.setDistributor(md);
            mbm.setPengguna(mpg);

            mdBM.setBarang_masuk(mbm);
            mdBM.setBarang(mb);
            mdBM.setJumlah_masuk(jumlah);
            mdBM.setSubtotal_masuk(subTotal);        
            mdBM.setStatus(status);

            mkm.setBarang_masuk(mbm);
            mkm.setBarang(mb);
            mkm.setDetail_barang_masuk(mdBM);

            serviceKM.updateData(mkm);
            tbmKM.updateData(row, mkm);
    ...
    private void saveData() {
        ...
        serviceBM.addData(mbm);
        serviceBM.updateStok();
        serviceDBM.addData(mdBM);
    ...
    private void showReport(String id) {
        ...
        serviceLap.laporan1PopUp("LaporanBarangMasukPertransaksi", id);
    }
}
